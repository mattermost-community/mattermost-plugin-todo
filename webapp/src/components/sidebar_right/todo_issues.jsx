    ...
    return props.issues.length > 0 ? (
        props.issues.map((issue) => {
            ...
            const issueComponent =
                PostUtils.messageHtmlToComponent(htmlFormattedText);
                ...
                >
                    <div className='todo-item__content'>
                        ...
                        <div style={style.itemContent}>
                            ...
                            {(canRemove(props.list, issue.list) ||
                                canComplete(props.list) ||
                                canAccept(props.list) ||
                                canBump(props.list, issue.list)) &&
                                actionButtons}
                            <div
                                className='light'
                                style={style.subtitle}
